...
import static ch.imagic.ffmpeg.nut.StreamHeaderPacket.fourccToString;
...
public class RawHandler {
    ...
    public static AudioFormat streamToAudioFormat(final StreamHeaderPacket header) {
        ...
        if (Arrays.equals(fourcc, new byte[] {'A', 'L', 'A', 'W'})) {
            ...
            if (interleaving != 'D') {
                throw new IllegalArgumentException("unsupported interleaving '"
                        + interleaving
                        + "' in fourcc value '"
            ...
            switch (type) {
                ...
                case 'F':
                    ...
                    break;
                default:
                    throw new IllegalArgumentException("unknown fourcc '" + fourccToString(fourcc) + "' type: " + type);
            }
        } else {
            throw new IllegalArgumentException("unknown fourcc value: '" + fourccToString(fourcc) + "'");
        }

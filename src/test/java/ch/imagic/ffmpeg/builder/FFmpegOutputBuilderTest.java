...
public class FFmpegOutputBuilderTest {
    ...
    public void testEnabledCompositeEncodingOptionsDelegateAllSections() {
        ...
        assertEquals(AUDIO_SAMPLE_48000, actual.audio.sampleRate);
        assertEquals(AUDIO_FORMAT_S16, actual.audio.sampleFormat);
        assertEquals(128000, actual.audio.bitRate);
        ...
        assertEquals(FPS_30, actual.video.frameRate);
        assertEquals(320, actual.video.width);
        assertEquals(240, actual.video.height);
        assertEquals(800000, actual.video.bitRate);

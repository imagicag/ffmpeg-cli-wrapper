...
public final class Progresses {
    ...
    public static final List<String> allFiles = List.of("ffmpeg-progress-0", "ffmpeg-progress-1", "ffmpeg-progress-2");

    public static final List<Progress> allProgresses = List.of(
